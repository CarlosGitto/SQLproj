...
def seed_tables(products_num: int, sales_num: int, expense_items_num: int, assigned_expense_items_num: int):
    
    """ Read a file of SQL statements and split them by ';' """
    
    insert_file =  open("RawSQL/insert_querys/insert.sql","r").read().split(";")
